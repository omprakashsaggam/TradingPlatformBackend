...
import com.coinTrade.domain.PaymentOrderStatus;
import com.coinTrade.model.PaymentOrder;
import com.coinTrade.model.User;
import com.coinTrade.repository.PaymentOrderRepository;
...
public class PaymentServiceImpl implements PaymentService{
    ...
    public PaymentResponse createRazorpayPaymentLink(User user,
        ...
        try {
            ...
            paymentLinkRequest.put("callback_url","https://trading-platform-gold-three.vercel.app/wallet/"+orderId);
    ...
    public PaymentResponse createStripePaymentLink(User user, Long amount,Long orderId) throws StripeException {
        ...
        SessionCreateParams params = SessionCreateParams.builder()
                ...
                .setSuccessUrl("https://trading-platform-gold-three.vercel.app/wallet?order_id="+orderId)
                .setCancelUrl("https://trading-platform-gold-three.vercel.app/payment/cancel")
